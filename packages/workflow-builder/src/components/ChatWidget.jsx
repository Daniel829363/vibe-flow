...
const ChatWidget = ({ isOpen, toggleChat, messages, onSendMessage, isLoading, onClearHistory }) => {
  ...
  const formatMessageTime = (isoString) => {
    if (!isoString) return "";
    return new Date(isoString).toLocaleTimeString(locale === "ru" ? "ru-RU" : "en-US", {
      hour: "2-digit",
      minute: "2-digit",
    });
  };
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="font-semibold text-white">
                  {t("chat.assistantTitle", {}, "AI Assistant")}
                </h3>
            ...
            <div className="flex items-center gap-1">
              ...
              {messages.length > 0 && (
                <button
                  ...
                  title={t("chat.clearChat", {}, "Clear Chat History")}
                      ...
                      >
                        ...
                        {msg.suggestions && msg.suggestions.length > 0 && (
                          <div className="flex flex-col gap-2">
                            <p className="text-xs font-medium text-gray-400">{t("chat.suggestedActions", {}, "Suggested Actions:")}</p>
