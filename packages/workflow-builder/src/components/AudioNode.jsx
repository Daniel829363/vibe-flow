    ...
    try {
      ...
      incomingEdges.forEach((edge) => {
        ...
        if (sourceVal && typeof sourceVal === "string" && sourceVal.trim()) {
          if (edge.targetHandle === "audioInput") {
            localSources.audio_url = sourceVal;
          }
          if (edge.targetHandle === "audioInput2") {
            localSources.prompt = sourceVal;
          }
          if (edge.targetHandle === "audioInput3") {
            localSources.image_url = sourceVal;
            localSources.image = sourceVal;
          }
          if (edge.targetHandle === "audioInput4") {
      ...
      try {
        ...
        console.warn("Could not calculate dynamic cost before running audio node:", err);
      }
